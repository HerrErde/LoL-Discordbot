...
const rankedEmblem = {
    0: 'https://raw.githubusercontent.com/HerrErde/LoL-Discordbot/main/img/Emblem_Iron.png',
    1: 'https://raw.githubusercontent.com/HerrErde/LoL-Discordbot/main/img/Emblem_Bronze.png',
    2: 'https://raw.githubusercontent.com/HerrErde/LoL-Discordbot/main/img/Emblem_Silver.png',
    3: 'https://raw.githubusercontent.com/HerrErde/LoL-Discordbot/main/img/Emblem_Gold.png',
    4: 'https://raw.githubusercontent.com/HerrErde/LoL-Discordbot/main/img/Emblem_Platinum.png',
    5: 'https://raw.githubusercontent.com/HerrErde/LoL-Discordbot/main/img/Emblem_Diamond.png',
    6: 'https://raw.githubusercontent.com/HerrErde/LoL-Discordbot/main/img/Emblem_Master.png',
    7: 'https://raw.githubusercontent.com/HerrErde/LoL-Discordbot/main/img/Emblem_Grandmaster.png',
    8: 'https://raw.githubusercontent.com/HerrErde/LoL-Discordbot/main/img/Emblem_Challenger.png',
};
...
module.exports = {
    ...
    async execute(message, args) {
        ...
        if (summonerData.hasOwnProperty('status') && summonerData.status.status_code == 404) {
            message.channel.send("Der Name dieses summoner, kann nicht gefunden werden!");
            return;
        }
        ...
        if (split[1] == 'mastery') {
            ...
            if (accountData.length == 0) {
                ...
                rankEmbed.setTitle('Rank Summary für ' + summonerName);
                rankEmbed.setDescription('Summoner Level: `' + summonerLevel + '`\nDieser Spieler ist gerade ohne Rank');
            } else {
                ...
                rankEmbed.setThumbnail('https://raw.githubusercontent.com/HerrErde/LoL-Discordbot/main/img/Emblem_Grandmaster.png');
            ...
            message.channel.send("Die angegebenen Parameter sind ungültig. Verwenden Sie !help für weitere Informationen.");
        }
    },
};